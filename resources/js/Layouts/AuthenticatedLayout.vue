...
<template>
    <div class="min-w-[1150px] bg-gray-100 h-full">
        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 ficed z-50 min-w-[1150px] w-full">
        ...
        <div class="flex items-center justify-between bg-[#232f3e] h-[38px] z-40 min-w-[1150px] w-full">
            ...
            <div class="flex">
                ...
                <div
                    class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-between px-2">
                        <div class="text-[14px] text-white font-extrabold">Amazon.com</div>
                    </div>
                </div>
        ...
        <div class="w-full bg-white mt-10 overflow-x-scroll">
            <div class="max-w-[1500px] mx-auto">
                ...
                <div class="flex justify-center item-stretch">
